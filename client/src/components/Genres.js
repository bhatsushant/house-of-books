...
const Genres = () => {
    ...
    const booksArray = [
        ...
        {
            'Book Id': 31831397,
            Title: 'Rock The Dancefloor: The proven five-step formula for total DJing success',
            Author: 'Phil Morse',
            'Author l-f': 'Morse, Phil',
            'Additional Authors': '',
            ISBN: '="',
            ISBN13: '="',
            'My Rating': 0,
    ...
    //                 `https://www.googleapis.com/books/v1/volumes?q="${eachBook.Title}"&maxResults=1&key=AIzaSyDy2BCW2oOOT54LFV6a57ZFygMTmb87OcI`
    //             );
    //             console.log(data);
    //         } catch (e) {
    //             console.log(e);
    ...
    //         newObject = {
    //             ISBN: parseInt(eachBook.ISBN),
    //             url: 'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1459115220l/27968891.jpg',
    //             description: 'How google runs',
    //             author: 'Betsy Beyer',
    //             averageRating: 4.23,
    //             binding: 'Paperback',
    //             genre: 'Sci-fi',
    ...
    return <div>{console.log(genreData)}</div>;
};
